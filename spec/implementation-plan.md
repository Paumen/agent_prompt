...
5. [Phase A3 — Build Pipeline & Flow Loading](#5-phase-2--build-pipeline--flow-loading)
6. [Phase A4 — GitHub API & Caching](#6-phase-3--github-api--caching)
7. [Phase A5 — Card 1: Configuration](#7-phase-4--card-1-configuration)
8. [Phase A6 — Card 2: Task (Dual-Panel)](#8-phase-5--card-2-task-dual-panel)
9. [Phase A7 — Card 3: Steps (Auto-Generated)](#9-phase-6--card-3-steps-auto-generated)
10. [Phase A8 — Card 4: Prompt Output](#10-phase-7--card-4-prompt-output)
11. [Phase A9 — Polish & Constraints](#11-phase-8--polish--constraints)
12. [Phase B1 — Global Visual Foundation](#12-phase-9--global-visual-foundation)
13. [Phase B2 — Config Card Refinement](#13-phase-10--config-card-refinement)
14. [Phase B3 — Task Card (Dual-Panel)](#14-phase-11--task-card-dual-panel)
15. [Phase B4 — Steps Card & Output Logic](#15-phase-12--steps-card--output-logic)
16. [Phase B5 — Prompt Card & Action Header](#16-phase-13--prompt-card--action-header)
17. [Phase B6 — Final UAT & Regression](#17-phase-14--final-uat--regression)
...
## 5. Phase A3 — Build Pipeline & Flow Loading
...
## 7. Phase A5 — Card 1: Configuration
...
## 8. Phase A6 — Card 2: Task (Dual-Panel)
...
## 9. Phase A7 — Card 3: Steps (Auto-Generated)
...
## 10. Phase A8 — Card 4: Prompt Output
...
## 11. Phase A9 — Polish & Constraints
...
## 12. Phase C1 — Global Visual Foundation
...
## 13. Phase C2 — Config Card Refinement
...
## 14. Phase C3 — Task Card (Dual-Panel)
...
## 15. Phase C4 — Steps Card & Output Logic
...
## 16. Phase C5 — Prompt Card & Action Header
...
## 17. Phase C6 — Final UAT & Regression
