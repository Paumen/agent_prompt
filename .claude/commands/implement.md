...
2. If you need more context about task schemas, lenses, or flow configurations, search the brainstorm file (`spec_and_framework_and_schemas_trade-offs.md`) for the relevant section only — do NOT read the entire file.
